...
Before you can join and connect to your Fractal Minecraft server, you'll need to find the [IP](https://whatismyipaddress.com/ip-address) (a combination of numbers, e.g `123.123.123.123`) or a subdomain (letters, e.g `test.sryden.io`).

1. Head to the [Fractal dashboard](https://frac.gg/auth)
2. Locate the subdomain or IP:port below the name of the server after clicking **Manage Server**
