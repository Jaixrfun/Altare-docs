...
description: "Learn how to install any Forge or custom modpacks on your Minecraft server."
---
...
To get started with installing your favourite modpack on your Minecraft server, first, [upload the modpack's server archive](../panel/importing-files) (usually in a `.zip` format) to your file manager on the dashboard.
