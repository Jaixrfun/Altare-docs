...
If you wish to upload a singleplayer world from your computer to a [Minecraft server](https://frac.gg), follow these steps: 
...
1. Stop the server
2. [Upload the world archive](../../importing-files) to the **File Manager** on the [dashboard](https://frac.gg/auth)
